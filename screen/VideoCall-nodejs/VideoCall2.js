...
export default function VideCall2({}) {
  ...
  const socket = SocketIOClient('http://192.168.120.140:3500', {
  ...
  useEffect(() => {
    try {
      ...
      peerConnection.current.onaddtrack = event => {
        console.log('test masuk sini breee', event.stream);
      ...
      <View
        ...
        <View
          ...
          <IconContainer
            ...
            Icon={() => {
              return <Text>Camera Switch</Text>;
